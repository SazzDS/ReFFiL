...
function coverEyes() {
	...
	TweenMax.to(armR, 0.45, {x: -93, y: 2, rotation: 0, ease: Quad.easeOut, delay: 0});
}

function uncoverEyes() {
	TweenMax.to(armL, 1.35, {y: 220, ease: Quad.easeOut});
	TweenMax.to(armL, 1.35, {rotation: 105, ease: Quad.easeOut, delay: 0});
	TweenMax.to(armR, 1.35, {y: 220, ease: Quad.easeOut});
	TweenMax.to(armR, 1.35, {rotation: -105, ease: Quad.easeOut, delay: 0});
}
...
email.addEventListener('focusout', onEmailFocusout);
email.addEventListener('input', onEmailInput);
password.addEventListener('focus', onPasswordFocus);
password.addEventListener('blur', onPasswordBlur);
password.addEventListener('focusout', onPasswordFocusout);
